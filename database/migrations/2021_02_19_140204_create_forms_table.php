...
class CreateFormsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('forms', function (Blueprint $table) {
            ...
            $table->enum('intWithOngoingCovid', [0,1])->nullable();
            ...
            $table->enum('locWithOngoingCovid1', [0,1])->nullable();
            ...
            $table->enum('locWithOngoingCovid2', [0,1])->nullable();
            ...
            $table->enum('locWithOngoingCovid3', [0,1])->nullable();
            ...
            $table->enum('locWithOngoingCovid4', [0,1])->nullable();
            ...
            $table->enum('locWithOngoingCovid5', [0,1])->nullable();
            ...
            $table->enum('locWithOngoingCovid6', [0,1])->nullable();
            ...
            $table->enum('locWithOngoingCovid7', [0,1])->nullable();
