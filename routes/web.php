...
Route::group(['middleware' => ['auth','verified','isAccountEnabled', 'canAccessPidsr']], function() {
    ...
    Route::get('/pidsr/download_excel/{case}', [PIDSRController::class, 'downloadExcel'])->name('pidsr_download_excel');
    ...
    Route::post('/edcs/dengue_clustering/new_schedule', [PIDSRController::class, 'storeCustomSchedule'])->name('dengue_store_customschedule');
...
Route::post('/edcs/{facility_code}/disease_reporting/download_csv', [PIDSRController::class, 'processCsvTemplateDownload'])->name('edcs_facility_download_csv');
...
Route::group(['middleware' => ['auth','verified','isAccountEnabled', 'canAccessEmployees']], function() {
    ...
    Route::get('bls_home_masterlist', [EmployeesController::class, 'blsHomeMasterlist'])->name('bls_home_masterlist');
    ...
    Route::post('bls_home_batches/store', [EmployeesController::class, 'storeBlsMember'])->name('bls_storemember');
    Route::post('bls/{batch_id}/view/store', [EmployeesController::class, 'joinParticipant'])->name('bls_joinparticipant');
    ...
    Route::get('bls_participant/{participant_id}', [EmployeesController::class, 'viewBlsMember'])->name('bls_viewparticipant');
    Route::post('bls_participant/{participant_id}/update', [EmployeesController::class, 'updateBlsMember'])->name('bls_updateparticipant');
...
Route::group(['middleware' => ['auth','verified', 'isAccountEnabled', 'canAccessAbtc']], function () {
    ...
    Route::get('/abtc/vaccine_counter', [ABTCVaccinationController::class, 'abtcVaccineCounterHome'])->name('abtc_vaccinecounter_home');

    Route::get('/abtc/financial', [ABTCVaccinationController::class, 'abtcFinancialHome'])->name('abtc_financial_home');
...
Route::group(['middleware' => ['auth','verified','isAccountEnabled', 'canAccessFhsisOrElectronicTcl']], function()
{
    ...
    Route::get('/fhsis/deathcert/search', [FhsisController::class, 'deathCertSearch'])->name('fhsis_deathcert_search');
...
Route::group(['middleware' => ['auth','verified', 'isAccountEnabled', 'canAccessPharmacy']], function() {
    ...
    Route::post('/pharmacy/process/patient/{id}/process_cart', [PharmacyController::class, 'selectCartTransaction'])->name('pharmacy_patient_process_cart');
...
Route::middleware(['auth','verified', 'canAccessElectronicTcl'])->group(function () {
    ...
    Route::post('/family_planning/view/{id}/process_next_visit', [ElectronicTclController::class, 'updateFamilyPlanningVisit'])->name('etcl_familyplanning_process_next_visit');
});
