<table class="table table-bordered table-striped" id="mainTbl">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">{{ $record->patient->getAge() }}</td>
            <td class="text-center">{{ $record->patient->gender }}</td>
            <td class="text-center">{{ $record->mother_name }}</td>
            <td class="text-center">
                <div><small>{{ $record->patient->getStreetPurok() }}</small></div>
                <div>BRGY. {{ $record->patient->address_brgy_text }}</div>
            </td>
