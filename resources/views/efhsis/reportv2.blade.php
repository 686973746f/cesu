            ...
            <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5>Total Deaths Non-GenTri Residents = {{$tot_deaths_outsidecity_m + $tot_deaths_outsidecity_f}} (Male: {{$tot_deaths_outsidecity_m}} Female: {{$tot_deaths_outsidecity_f}})</h5>
                        <div class="row">
                            <div class="col-6">
