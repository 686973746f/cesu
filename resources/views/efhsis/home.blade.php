            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#modelId">Non-Comm</button>
                        <hr>
                    ...
                    <div id="ncAccordian" role="tablist" aria-multiselectable="true">
                        <div class="card">
                            <div class="card-header" role="tab" id="ncSection1Header">
                                <a data-toggle="collapse" data-parent="#ncAccordian" href="#ncSection1" aria-expanded="true" aria-controls="ncSection1">New Entry</a>
                            </div>
