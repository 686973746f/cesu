                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center font-weight-bold">{{$i['suspected_count'] + $i['confirmed_count'] + $i['negative_count'] + $i['recovered_count'] + $i['abtc_count']}}</td>
                        </tr>
                        @php
                    ...
                    <tfoot class="text-center font-weight-bold">
                        <tr>
                            ...
                            <td>{{$gt_negative}}</td>
                            <td>{{$gt_abtc}}</td>
                            <td>{{$gt_suspected + $gt_confirmed + $gt_negative + $gt_recovered + $gt_abtc}}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
