		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="form-check form-check-inline">
					...
					<label class="form-check-label">
						<input class="form-check-input" type="radio" name="hasoccupation" id="hasoccupation_yes" value="1" {{(old('hasoccupation') == 1) ? 'checked' : 'checked'}}> Yes
					</label>
				</div>
				<div id="occupation_div">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="occupation" id="occupation" value="{{old('occupation')}}" required>
								@error('occupation')
									<small class="text-danger">{{$message}}</small>
								@enderror
							</div>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="" id="" value="{{$list->companyName}}" disabled>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="">Region</small></label>
								<input type="text" class="form-control" id="" name="" value="{{$list->loc_region}}" disabled>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="">Province</small></label>
								<input type="text" class="form-control" id="" name="" value="{{$list->loc_province}}" disabled>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="">Municipality/City</small></label>
								<input type="text" class="form-control" id="" name="" value="{{$list->loc_city}}" disabled>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="">Barangay</small></label>
								<input type="text" class="form-control" id="" name="" value="{{$list->loc_brgy}}" disabled>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								<label for="">Lot/Building <small>(Optional)</small></label>
								<input type="text" class="form-control" id="" name="" value="{{$list->loc_lotbldg}}" disabled>
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label for="">Street</label>
								<input type="text" class="form-control" id="" name="" value="{{$list->loc_street}}" disabled>
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label for="">Phone/Mobile No.</label>
								<input type="text" class="form-control" id="" name="" value="{{$list->contactNumber}}" disabled>
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label for="">Email</label>
								<input type="text" class="form-control" name="" id="" value="{{$list->email}}" disabled>
							</div>
						</div>
					</div>
				</div>
