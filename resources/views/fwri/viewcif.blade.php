                                ...
                                <div class="col-md-4">
                                    ...
                                    <label for="reffered_anotherhospital"><span class="text-danger font-weight-bold">*</span>Referral from another hospital?</label>
                                        <select class="form-control" name="reffered_anotherhospital" id="reffered_anotherhospital" required>
                                            <option value="N" {{(old('reffered_anotherhospital', $d->reffered_anotherhospital) == 'HOME') ? 'selected' : ''}}>No</option>
                                            <option value="Y" {{(old('reffered_anotherhospital', $d->reffered_anotherhospital) == 'HOME') ? 'selected' : ''}}>Yes</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <label for="involvement_type"><span class="text-danger font-weight-bold">*</span>Type of Involvement</label>
                                        <select class="form-control" name="involvement_type" id="involvement_type" required>
                                            ...
                                            <option value="PASSIVE" {{(old('involvement_type', $d->involvement_type) == 'STREET') ? 'selected' : ''}}>PASSIVE (NADAMAY LANG)</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <label for="treatment_given"><span class="text-danger font-weight-bold">*</span>Treatment Given (multiple responses)</label>
                                        <select class="form-control" name="treatment_given[]" id="treatment_given" multiple required>
                                            ...
                                            <option value="OTHER" {{(in_array('OTHER', explode(',', old('treatment_given', $d->treatment_given)))) ? 'selected' : ''}}>OTHER, SPECIFY</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <label for="disposition_after_admission"><span class="text-danger font-weight-bold">*</span>Disposition after admission</label>
                                        <select class="form-control" name="disposition_after_admission" id="disposition_after_admission" required>
                                            ...
                                            <option value="DISCHARGED IMPROVED" {{(old('disposition_after_admission', $d->disposition_after_admission) == 'DISCHARGED IMPROVED') ? 'selected' : ''}}>DISCHARGED IMPROVED</option>
                                            <option value="HOME AGAINST MEDICAL ADVICE (HAMA)" {{(old('disposition_after_admission', $d->disposition_after_admission) == 'HOME AGAINST MEDICAL ADVICE (HAMA)') ? 'selected' : ''}}>HOME AGAINST MEDICAL ADVICE (HAMA)</option>
                                            <option value="ABSCONDED" {{(old('disposition_after_admission', $d->disposition_after_admission) == 'ABSCONDED') ? 'selected' : ''}}>ABSCONDED/UMALIS</option>
                                            <option value="TRANSFERRED TO ANOTHER HOSPITAL" {{(old('disposition_after_admission', $d->disposition_after_admission) == 'TRANSFERRED TO ANOTHER HOSPITAL') ? 'selected' : ''}}>TRANSFERRED TO ANOTHER HOSPITAL</option>
                                            <option value="DIED DURING ADMISSION" {{(old('disposition_after_admission', $d->disposition_after_admission) == 'DIED DURING ADMISSION') ? 'selected' : ''}}>DIED DURING ADMISSION</option>
                                        </select>
                                    </div>
