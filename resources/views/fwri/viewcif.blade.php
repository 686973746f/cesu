                                ...
                                <div class="col-md-4">
                                    ...
                                    <label for="disposition_after_admission"><span class="text-danger font-weight-bold">*</span>Disposition after admission</label>
                                        <select class="form-control" name="disposition_after_admission" id="disposition_after_admission" required>
                                            ...
                                            <option value="DISCHARGED IMPROVED" {{(old('disposition_after_admission', $d->disposition_after_admission) == 'DISCHARGED IMPROVED') ? 'selected' : ''}} id="da_option1">DISCHARGED IMPROVED</option>
                                            ...
                                            <option value="ABSCONDED" {{(old('disposition_after_admission', $d->disposition_after_admission) == 'ABSCONDED') ? 'selected' : ''}} id="da_option3">ABSCONDED/UMALIS</option>
