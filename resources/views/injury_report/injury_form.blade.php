        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control" name="consultation_datetime" id="consultation_datetime" value="{{old('consultation_datetime', $d->consultation_datetime)}}" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="form-group d-none" id="injurydiv1">
                    ...
                    <div class="form-group d-none" id="injurydiv2">
                        <label for="abrasion_site" class="form-label"><b class="text-danger">*</b>Specify Body (Site) Location of the Abrasion</label>
                        <input type="text" class="form-control" id="injury_site2" name="abrasion_site" style="text-transform: uppercase;" value="{{old('abrasion_site')}}">
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                    ...
                    <div class="form-group d-none" id="burn_div">
                    ...
                    <div class="form-group d-none" id="injurydiv3">
                        <label for="abrasion_site" class="form-label"><b class="text-danger">*</b>Specify Body (Site) Location of the Abrasion</label>
                        <input type="text" class="form-control" id="injury_site3" name="abrasion_site" style="text-transform: uppercase;" value="{{old('abrasion_site')}}">
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                    ...
                    <div class="form-group d-none" id="injurydiv4">
                        <label for="abrasion_site" class="form-label"><b class="text-danger">*</b>Specify Body (Site) Location of the Abrasion</label>
                        <input type="text" class="form-control" id="injury_site3" name="abrasion_site" style="text-transform: uppercase;" value="{{old('abrasion_site')}}">
                    </div>
                    <div class="form-check">
                    ...
                    <div class="form-group d-none" id="injurydiv5">
                        <label for="abrasion_site" class="form-label"><b class="text-danger">*</b>Specify Body (Site) Location of the Abrasion</label>
                        <input type="text" class="form-control" id="injury_site3" name="abrasion_site" style="text-transform: uppercase;" value="{{old('abrasion_site')}}">
                    </div>
                    <div class="form-check">
                    ...
                    <div id="fracture_div" class="d-none">
                        <div class="form-check">
                            <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="fracture_closed" id="fracture1" value="Y">
                            Closed Type
                            </label>
                        </div>
                        <div class="form-group d-none" id="fracture_div1">
                            <label for="abrasion_site" class="form-label"><b class="text-danger">*</b>Specify Body (Site) Location of the Abrasion</label>
                            <input type="text" class="form-control" id="injury_site3" name="abrasion_site" style="text-transform: uppercase;" value="{{old('abrasion_site')}}">
                        </div>
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="fracture_open" id="fracture2" value="Y">
                            Open Type
                            </label>
                        </div>
                        <div class="form-group d-none" id="fracture_div1">
                    ...
                    <div class="form-group d-none" id="injurydiv6">
                        <label for="abrasion_site" class="form-label"><b class="text-danger">*</b>Specify Body (Site) Location of the Abrasion</label>
                        <input type="text" class="form-control" id="injury_site3" name="abrasion_site" style="text-transform: uppercase;" value="{{old('abrasion_site')}}">
                    </div>
                    <div class="form-check">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" name="bites_stings" id="external3" value="Y">
                        Chemical/substance
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" name="bites_stings" id="external4" value="Y">
                        Contact with sharp objects
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" name="bites_stings" id="external5" value="Y">
                        Drowning
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" name="bites_stings" id="external6" value="Y">
                        Exposure to forces of nature
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" name="bites_stings" id="external7" value="Y">
                        Fall
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" name="bites_stings" id="external8" value="Y">
                        Firecracker
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" name="bites_stings" id="external9" value="Y">
                        Sexual Assault/Sexual Abuse/Rape (Alleged)
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" name="bites_stings" id="external10" value="Y">
                        Gunshot
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" name="bites_stings" id="external11" value="Y">
                        Hanging/Strangulation
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" name="bites_stings" id="external12" value="Y">
                        Mauling/Assault
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" name="bites_stings" id="external13" value="Y">
                        Transport/Vehicular Accident
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" name="bites_stings" id="external14" value="Y">
                        Others
                        </label>
                    </div>
