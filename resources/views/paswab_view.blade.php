                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" name="q" value="{{request()->input('q')}}" placeholder="Search Name / Schedule Code / Referral Code" style="text-transform: uppercase;" required>
                            ...
                            <tbody>
                                @foreach ($list as $item)
                                    <tr>
                                        ...
                                        <td class="text-center" style="vertical-align: middle;"><span class="{{($item->getPatientType() == 'FOR TRAVEL') ? 'font-weight-bold text-danger' : ''}}">
                                            {{$item->getPatientType()}}</span>
                                            @if(!is_null($item->expoDateLastCont) && $item->pType == 'CLOSE CONTACT')<span class="badge badge-primary">{{Carbon\Carbon::parse($item->expoDateLastCont)->diffInDays()}} D</span>@endif
                                        </td>
