                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="body_site[]" id="body_site" multiple>
                                  ...
                                  <option value="HEAD" {{ in_array('HEAD', old('body_site', explode(",", $d->body_site))) ? 'selected' : '' }}>Head/Ulo</option>
                                  ...
                                  <option value="OTHERS" {{ in_array('OTHERS', old('body_site', explode(",", $d->body_site))) ? 'selected' : '' }}>Others/Iba pa</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="height" id="height" value="{{old('height', $d->height)}}" min="1" max="1000" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="weight" class="form-label"><strong class="text-danger">*</strong>Weight (kg)</label>
                                <input type="number" class="form-control" name="weight" id="weight" value="{{old('weight', $d->weight)}}" min="1" max="1000" required>
                            </div>
                        </div>
                    </div>
                </div>
