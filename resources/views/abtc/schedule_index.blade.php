                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center">
                                        ...
                                        <a href="{{route('abtc_encode_process', ['br_id' => $n->id, 'dose' => $n->getCurrentDose()])}}?fsc=1" class="btn btn-primary" onclick="return confirm('The patient should be present and injected with the 28th Day Dose. Click OK to Continue.')">Mark as Done</a>
                                        @endif
                                    </td>
                                    <td class="text-center"><a href="{{route('abtc_encode_edit', $n->id)}}">{{$n->case_id}}</a></td>
                                    <td>{{$n->patient->getName()}}</td>
