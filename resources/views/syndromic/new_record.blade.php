            ...
            <div class="card-body">
                ...
                <div class="form-group {{(auth()->user()->isSyndromicHospitalLevelAccess()) ? 'd-none' : ''}}" id="purpose_div">
                  ...
                  <div class="form-check form-check-inline">
                      <input class="form-check-input" type="checkbox" id="type_{{$ind}}" name="consultation_type[]" value="{{mb_strtoupper($ref1)}}" {{($get_disabled) ? 'disabled' : ''}} {{($ref1 == 'General' || $auto_check) ? 'checked' : ''}}>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control bp-field" name="bloodpressure" id="bloodpressure" value="{{old('bloodpressure')}}" {{($required_bp) ? 'required' : ''}}>
                      </div>
                    </div>
                </div>
                <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <div id="rash_div" class="d-none">
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" name="rash_isMaculopapular" id="rash_isMaculopapular" value="checkedValue" {{(old('rash_isMaculopapular')) ? 'checked' : ''}}>
                                Maculopapular Rash - Mapulang batik (macules) at maliliit na nakaumbok na bukol (papules)
                              </label>
                            </div>
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" name="rash_isPetechia" id="rash_isPetechia" value="checkedValue" {{(old('rash_isPetechia')) ? 'checked' : ''}}>
                                Petechia - Maliliit na pula o violet na tuldok sa balat
                              </label>
                            </div>
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" name="rash_isPurpura" id="rash_isPurpura" value="checkedValue" {{(old('rash_isPurpura')) ? 'checked' : ''}}>
                  ...
                  <div class="col-md-{{$colsize3}}">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="name_of_physician" id="name_of_physician" required>
                        ...
                        @else
                          @foreach($doclist as $dr)
                          <option value="{{$dr->doctor_name}}" {{(old('name_of_physician', (auth()->user()->getItrDefaultDoctor()) ? auth()->user()->getItrDefaultDoctor()->doctor_name : NULL) == $dr->doctor_name) ? 'selected' : ''}} class="{{(in_array($dr->dru_name, ['CHO GENERAL TRIAS', 'GENERAL TRIAS SUPER HEALTH CENTER'])) ? 'official_drlist' : 'outside_drlist'}}">{{$dr->doctor_name}} ({{$dr->dru_name}})</option>
                          @endforeach
                        @endif
