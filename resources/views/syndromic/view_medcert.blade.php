        ...
        <div class="card">
            ...
            <div class="card-body" id="divToPrint">
                ...
                <div class="d-flex justify-content-between h5">
                    ...
                    <div>
                        Age: <u>{{$d->displayAgeStringToReport()}}</u>
                    </div>
                    <div>
