                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="testingCat" id="testingCat" required>
                        <option value="ALL (Except A1, A2 and A3) with Symptoms of COVID-19" {{(old('testingCat', $records->testingCat) == 'ALL (Except A1, A2 and A3) with Symptoms of COVID-19') ? 'selected' : ''}}>ALL (Except A1, A2 and A3) with Symptoms of COVID-19</option>
