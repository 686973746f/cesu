        ...
        <form action="/forms/{{$records->id}}{{(request()->get('fromView') && request()->get('sdate') && request()->get('edate')) ? "?fromView=".request()->get('fromView')."&sdate=".request()->get('sdate')."&edate=".request()->get('edate')."" : ''}}" method="POST">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">To be filled by Contact Tracers ONLY <small>(Check all that apply)</small></div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="is_primarycc" id="is_primarycc" value="1" {{(old('is_primarycc', $records->is_primarycc) == 1) ? 'checked' : ''}}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="is_secondarycc" id="is_secondarycc" value="1" {{(old('is_secondarycc', $records->is_secondarycc) == 1) ? 'checked' : ''}}>
                                    ...
                                    <div id="secondarycc_div" class="d-none">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="is_secondarycc_date" id="is_secondarycc_date" min="{{date('Y-m-d', strtotime('-3 Months'))}}" max="{{date('Y-m-d')}}" value="{{old('is_secondarycc_date', $records->is_secondarycc_date)}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                          <input type="checkbox" class="form-check-input" name="is_tertiarycc" id="is_tertiarycc" value="1" {{(old('is_tertiarycc', $records->is_tertiarycc) == 1) ? 'checked' : ''}}>
                                    ...
                                    <div id="tertiarycc_div" class="d-none">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="is_tertiarycc_date" id="is_tertiarycc_date" min="{{date('Y-m-d', strtotime('-3 Months'))}}" max="{{date('Y-m-d')}}" value="{{old('is_tertiarycc_date', $records->is_tertiarycc_date)}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
