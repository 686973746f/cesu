...
@section('content')
    <div class="container">
        ...
        <div class="text-right mb-3">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#transferModal"><i class="fas fa-exchange-alt mr-2"></i>Transfer CIF to Other Patient</button>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="testingCat" id="testingCat" required>
                        <option value="A4" {{(old('testingCat', $records->testingCat) == 'A4') ? 'selected' : ''}}>A4</option>
                        <option value="A1" {{(old('testingCat', $records->testingCat) == 'A1') ? 'selected' : ''}}>A1 - Frontline Workers in Health Facilities</option>
                        <option value="A2" {{(old('testingCat', $records->testingCat) == 'A2') ? 'selected' : ''}}>A2 - Senior Citizens/Persons Aged 60 and above</option>
                        <option value="A3" {{(old('testingCat', $records->testingCat) == 'A3') ? 'selected' : ''}}>A3 - Hospitalization/Pregnant/Operation/Comorbidities</option>
                        <!--
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @endif
                                            @if(!is_null($records->records->vaccinationDate3))
                                            <hr>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                      <label for="">3.) Booster Dose Date</label>
                                                      <input type="date" class="form-control" name="" id="" value="{{$records->records->vaccinationDate3}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="">Vaccination Center/Facility</label>
                                                        <input type="text" class="form-control" name="" id="" value="{{($records->records->vaccinationFacility3) ? $records->records->vaccinationFacility3 : 'N/A'}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="">Region of Health Facility</label>
                                                        <input type="text" class="form-control" name="" id="" value="{{($records->records->vaccinationRegion3) ? $records->records->vaccinationRegion3 : 'N/A'}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="">Adverse Event/s</label>
                                                        <input type="text" class="form-control" name="" id="" value="{{($records->records->haveAdverseEvents3 == 1) ? 'YES' : 'NO'}}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
                                            @if(!is_null($records->records->vaccinationDate4))
                                            <hr>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                      <label for="">4.) 2ND Booster Dose Date</label>
                                                      <input type="date" class="form-control" name="" id="" value="{{$records->records->vaccinationDate4}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="">Vaccination Center/Facility</label>
                                                        <input type="text" class="form-control" name="" id="" value="{{($records->records->vaccinationFacility4) ? $records->records->vaccinationFacility4 : 'N/A'}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="">Region of Health Facility</label>
                                                        <input type="text" class="form-control" name="" id="" value="{{($records->records->vaccinationRegion4) ? $records->records->vaccinationRegion4 : 'N/A'}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="">Adverse Event/s</label>
                                                        <input type="text" class="form-control" name="" id="" value="{{($records->records->haveAdverseEvents4 == 1) ? 'YES' : 'NO'}}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="ifOutcomeRecovered">
                                        <div class="form-group">
                                          ...
                                          <input type="date" class="form-control" name="outcomeRecovDate" id="outcomeRecovDate" min="2020-01-01" max="{{date('Y-m-d')}}" value="{{old('outcomeRecovDate', $records->outcomeRecovDate)}}">
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" name="outcomeDeathDate" id="outcomeDeathDate" min="2020-01-01" max="{{date('Y-m-d')}}" value="{{old('outcomeDeathDate', $records->outcomeDeathDate)}}">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" class="form-control" name="localDateArrive1" id="localDateArrive1" value="{{old('localDateArrive1', $records->localDateArrive1)}}" min="{{date('Y-m-d', strtotime('-1 Month'))}}" max="{{date('Y-m-d')}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr>
