            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div id="ifVaccinated">
                        ...
                        <div class="form-group">
                            <label for="nameOfVaccine"><span class="text-danger font-weight-bold">*</span>Name of Vaccine</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-check">
                                            ...
                                            />
                                            <label class="form-check-label" for="signsCheck7">Sakit ng Katawan/Body Pain <small>(Myalgia)</small></label>
                                        </div>
                                        <div class="form-check">
                                            <input
                                                class="form-check-input"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-check">
                                            ...
                                            />
                                            <label class="form-check-label" for="signsCheck16">Kawalan ng Pang-Amoy/Loss of Smell</label>
                                        </div>
                                        <div class="form-check">
                                            <input
                                                class="form-check-input"
