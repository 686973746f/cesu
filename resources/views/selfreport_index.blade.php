...
@section('content')
    ...
    @endphp
    @if($proceed == 1)
    <form action="" method="POST" id="myForm" name="wholeForm">
        @csrf
        <div class="container">
            <div class="card">
                <div class="card-header font-weight-bold text-primary">Self-Report</div>
                <div class="card-body">
                    @if(session('msg'))
                    ...
                    @endif
                    <div class="card mb-3">
                        <div class="card-header font-weight-bold">1. Personal Information</div>
                        <div class="card-body">
