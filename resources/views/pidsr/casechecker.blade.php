    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <div>
                    <a href="{{route('pidsr_download_excel', ['case' => $modelName, 'year' => request()->input('year'), 'showDisabled' => request()->input('showDisabled') ?: 0, 'showNonMatchCaseDef' => request()->input('showNonMatchCaseDef') ?: 0])}}" class="btn btn-success">Export to Excel</a>
