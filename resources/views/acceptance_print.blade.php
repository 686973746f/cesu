    ...
    <div class="card">
        ...
        <div class="card-body" style="font-family: Arial, Helvetica, sans-serif">
            <div id="divToPrint">
                ...
                <p style="margin-left:5em;margin-right:5em;font-size:18px;text-align:justify;">&emsp;&emsp;This is to cerfiy <strong><u>{{$gcheck}}. {{$data->getName()}}</u></strong> is a resident of <strong><u>{{$data->getAddress()}}.</u></strong></p>
