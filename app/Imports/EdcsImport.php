    ...
    public function model(array $row)
    {
        if($row['current_address_city_municipality'] == 'City of General Trias' && $row['current_address_province'] == 'Cavite') {
            ...
            $table_params = [
                ...
                'RAatrophy' => ($row['left_arm'][0] == 'Yes') ? 'Y' : 'N',
                'LAatrophy' => ($row['left_arm'][1] == 'Yes') ? 'Y' : 'N',
                'RLatrophy' => ($row['right_leg'][0] == 'Yes') ? 'Y' : 'N',
                'LLatrophy' => ($row['left_leg'][0] == 'Yes') ? 'Y' : 'N',
    ...
    public function model(array $row) {
        if($row['current_address_city_municipality'] == 'City of General Trias' && $row['current_address_province'] == 'Cavite') {
            ...
            $table_params = [
                ...
                'MeasVacc' => ($row['patient_received_measles_containing_vaccine_mcv_if_yes_indicate_the_number_of_doses_whichever_is_applicable'] == 'Yes') ? 'Y' : 'N',
                'MVDose' => $row['mv'],
                'MRDose' => $row['mr'],
                'MMRDose' => $row['mmr'],
                ...
                'OtherCase' => ($row['are_there_other_known_cases_with_fever_and_rash_regardless_of_presence_of_3_caeursbr_in_the_community'] == 'Yes') ? 'Y' : 'N',
