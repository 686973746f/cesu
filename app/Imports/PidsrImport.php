                ...
                if($row[17] == 'CAVITE' && $row[16] == 'GENERAL TRIAS') {
                    ...
                    if($proceed && !($find_name)) {
                        $c = Abd::create([
                            ...
                            'EPIID' => $iepiid,
                            'UniqueKey' => $row[32],
                            'RECSTATUS' => (is_null($row[33]) || $row[33] == '') ? 0 : $row[33],
                            'SentinelSite' => $row[34],
                            'DeleteRecord' => $row[35],
                            'Year' => $row[36],
                            'NameOfDru' => $row[37],
                ...
                if($row[11] == 'CAVITE' && $row[12] == 'GENERAL TRIAS') {
                    ...
                    if($proceed && !($find_name)) {
                        $c = Afp::create([
                            ...
                            'EPIID' => $iepiid,
                            'UniqueKey' => $row[29],
                            'RECSTATUS' => (is_null($row[30]) || $row[30] == '') ? 0 : $row[30],
                            'Fever' => $row[31],
                ...
                if($row[16] == 'CAVITE' && $row[17] == 'GENERAL TRIAS') {
                    ...
                    if($proceed && !($find_name)) {
                        $c = Ahf::create([
                            ...
                            'EPIID' => $iepiid,
                            'UniqueKey' => $row[34],
                            'RECSTATUS' => (is_null($row[35]) || $row[35] == '') ? 0 : $row[35],
                            'SentinelSite' => $row[36],
                            'DeleteRecord' => $row[37],
                            'Year' => $row[38],
                            'NameOfDru' => $row[39],
                ...
                if($row[16] == 'CAVITE' && $row[17] == 'GENERAL TRIAS') {
                    ...
                    if($proceed && !($find_name)) {
                        $c = Ames::create([
                            ...
                            'EPIID' => $iepiid,
                            'UniqueKey' => $row[120],
                            'RECSTATUS' => (is_null($row[121]) || $row[121] == '') ? 0 : $row[121],
                ...
                if($row[12] == 'CAVITE' && $row[13] == 'GENERAL TRIAS') {
                    ...
                    if($proceed && !($find_name)) {
                        $c = Anthrax::create([
                            ...
                            'EPIID' => $iepiid,
                            'UniqueKey' => $row[28],
                            'RECSTATUS' => (is_null($row[29]) || $row[29] == '') ? 0 : $row[29],
                            'Occupation' => $row[30],
                            'Workplace' => $row[31],
                            'WorkAddress' => $row[32],
                ...
                if($row[1] == 'CAVITE' && $row[2] == 'GENERAL TRIAS') {
                    ...
                    if($proceed && !($find_name)) {
                        $c = Chikv::create([
                            ...
                            'DeleteRecord' => $row[75],
                            'Year' => $row[76],
                            'Recstatus' => (is_null($row[77]) || $row[77] == '') ? 0 : $row[77],
                            'UniqueKey' => $row[78],
                            'NameOfDru' => $row[79],
                            'ILHZ' => $row[80],
                            'District' => $row[81],
                ...
                if($row[1] == 'CAVITE' && $row[2] == 'GENERAL TRIAS') {
                    ...
                    if($proceed && !($find_name)) {
                        $c = Dengue::create([
                            ...
                            'DeleteRecord' => $row[36],
                            'Year' => $row[37],
                            'Recstatus' => (is_null($row[38]) || $row[38] == '') ? 0 : $row[38],
                            'UniqueKey' => $row[39],
                            'NameOfDru' => $row[40],
                            'ILHZ' => $row[41],
                            'District' => $row[42],
                ...
                if($row[16] == 'CAVITE' && $row[17] == 'GENERAL TRIAS') {
                    ...
                    if($proceed && !($find_name)) {
                        $c = Diph::create([
                            ...
                            'EPIID' => $iepiid,
                            'UniqueKey' => $row[33],
                            'RECSTATUS' => (is_null($row[34]) || $row[34] == '') ? 0 : $row[34],
                            'SentinelSite' => $row[35],
                            'DeleteRecord' => $row[36],
                            'Year' => $row[37],
                            'NameOfDru' => $row[38],
                ...
                if($row[11] == 'CAVITE' && $row[12] == 'GENERAL TRIAS') {
                    ...
                    if($proceed && !($find_name)) {
                        $c = Hfmd::create([
                            ...
                            'UniqueKey' => $row[52],
                            'RECSTATUS' => (is_null($row[53]) || $row[53] == '') ? 0 : $row[53],
                            'Travel' => $row[54],
                            'ProbExposure' => $row[55],
                            'OthExposure' => $row[56],
                            'OtherCase' => $row[57],
                ...
                if($row[17] == 'CAVITE' && $row[16] == 'GENERAL TRIAS') {
                    ...
                    if($proceed && !($find_name)) {
                        $c = Influenza::create([
                            ...
                            'EPIID' => $iepiid,
                            'UniqueKey' => $row[31],
                            'RECSTATUS' => (is_null($row[32]) || $row[32] == '') ? 0 : $row[32],
                            'SentinelSite' => $row[33],
                            'DeleteRecord' => $row[34],
                            'Year' => $row[35],
                            'NameOfDru' => $row[36],
            ...
            foreach ($rows as $row) {
                if($row[12] == 'CAVITE' && $row[13] == 'GENERAL TRIAS') {
                    ...
                    if($proceed && !($find_name)) {
                        ...
                        'AdmitToEntry' => (!empty($row[48])) ? $row[48] : 0,
                        'OnsetToAdmit' => (!empty($row[49])) ? $row[49] : 0,
                        'MorbidityMonth' => $row[50],
                        'MorbidityWeek' => $row[51],
                        'EPIID' => $iepiid,
                        'ReportToInvestigation' => (is_null($row[53]) || $row[53] == '') ? 0 : $row[53],
                        'UniqueKey' => $row[54],
                        'RECSTATUS' => (is_null($row[55]) || $row[55] == '') ? 0 : $row[55],
                        'Reasons' => $row[56],
                        'OtherReasons' => $row[57],
                ...
                if($row[14] == 'CAVITE' && $row[13] == 'GENERAL TRIAS') {
                    ...
                    if($proceed && !($find_name)) {
                        $c = Meningo::create([
                            ...
                            'Fever' => ($row[38] == 'True') ? 1 : 0,
                            'Seizure' => ($row[39] == 'True') ? 1 : 0,
                            'Malaise' => ($row[40] == 'True') ? 1 : 0,
                            'Headache' => ($row[41] == 'True') ? 1 : 0,
                            'StiffNeck' => ($row[42] == 'True') ? 1 : 0,
                            'Cough' => ($row[43] == 'True') ? 1 : 0,
                            'Rash' => ($row[44] == 'True') ? 1 : 0,
                            'Vomiting' => ($row[45] == 'True') ? 1 : 0,
                            'SoreThroat' => ($row[46] == 'True') ? 1 : 0,
                            'Petechia' => ($row[47] == 'True') ? 1 : 0,
                            'SensoriumCh' => ($row[48] == 'True') ? 1 : 0,
                            'RunnyNose' => ($row[49] == 'True') ? 1 : 0,
                            'Purpura' => ($row[50] == 'True') ? 1 : 0,
                            'Drowsiness' => ($row[51] == 'True') ? 1 : 0,
                            'Dyspnea' => ($row[52] == 'True') ? 1 : 0,
                            'Othlesions' => $row[53],
                            'OtherSS' => $row[54],
                            'ClinicalPres' => $row[55],
                ...
                if($row[12] == 'CAVITE' && $row[13] == 'GENERAL TRIAS') {
                    ...
                    if($proceed && !($find_name)) {
                        $c = Nt::create([
                            ...
                            'UniqueKey' => $row[41],
                            'RECSTATUS' => (is_null($row[42]) || $row[42] == '') ? 0 : $row[42],
                            'TotPreg' => $row[43],
                            'Livebirths' => $row[44],
                            'TTDose' => $row[45],
                            'LivingKids' => $row[46],
                ...
                if($row[12] == 'CAVITE' && $row[13] == 'GENERAL TRIAS') {
                    ...
                    if($proceed && !($find_name)) {
                        $c = Psp::create([
                            ...
                            'UniqueKey' => $row[30],
                            'RECSTATUS' => (is_null($row[31]) || $row[31] == '') ? 0 : $row[31],
                ...
                if($row[18] == 'CAVITE' && $row[19] == 'GENERAL TRIAS') {
                    ...
                    if($proceed && !($find_name)) {
                        $c = Rotavirus::create([
                            ...
                            'EPIID' => $iepiid,
                            'UniqueKey' => $row[68],
                            'RECSTATUS' => (is_null($row[69]) || $row[69] == '') ? 0 : $row[69],
                            'SentinelSite' => $row[70],
                            'DeleteRecord' => $row[71],
                            'Year' => $row[72],
                            'NameOfDru' => $row[73],
