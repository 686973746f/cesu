        ...
        */
        ...
        return [
            ...
            */
            ...
            (!is_null($form->records->vaccinationDate1)) ? mb_strtoupper($form->records->vaccinationFacility1) : 'GENERAL TRIAS, CAVITE',
            (!is_null($form->records->vaccinationDate1)) ? mb_strtoupper($form->records->vaccinationRegion1) : 'IV-A',
            ...
            (!is_null($form->records->vaccinationDate2)) ? mb_strtoupper($form->records->vaccinationFacility2) : 'GENERAL TRIAS, CAVITE',
            (!is_null($form->records->vaccinationDate2)) ? mb_strtoupper($form->records->vaccinationRegion2) : 'IV-A',
