...
class DisasterController extends Controller
{
    ...
    public function linkFamilyToEvac($id, Request $r) {
        ...
        $c = EvacuationCenterFamiliesInside::create([
            ...
            'outcome' => 'ALIVE',
            'is_injured' => $r->is_injured,
            'is_pregnant' => ($f->sex == 'F') ? $r->is_pregnant : 'N',
            'is_lactating' => ($f->sex == 'F') ? $r->is_lactating : 'N',
            'is_pwd' => $r->is_pwd,
            'shelterdamage_classification' => $r->shelterdamage_classification,
    ...
    public function updateEvacFamily($evac_id, $headinside_id, Request $r) {
        ...
        $d->update([
            ...
            'is_injured' => $r->is_injured,
            'is_pregnant' => ($d->familyHead->sex == 'F') ? $r->is_pregnant : 'N',
            'is_lactating' => ($d->familyHead->sex == 'F') ? $r->is_lactating : 'N',
            'is_pwd' => $r->is_pwd,
