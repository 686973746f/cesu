...
class ElectronicTclController extends Controller
{
    ...
    public function updateChildCare($id, Request $r) {
        ...
        */
        ...
        $table_params = [
            ...
            'bcg1' => $r->bcg1,
            'bcg_time' => ($r->filled('bcg1')) ? $r->bcg_time : NULL,
            'bcg1_type' => ($r->filled('bcg1')) ? $r->bcg1_type : NULL,
            //'bcg2' => $r->bcg2,
            //'bcg2_type' => $r->bcg2_type,
            'hepab1' => $r->hepab1,
            'hepab_time' => ($r->filled('hepab1')) ? $r->hepab_time : NULL,
            'hepab1_type' => ($r->filled('hepab1')) ? $r->hepab1_type : NULL,
            //'hepab2' => $r->hepab2,
    ...
    public function storeChildNutrition($patient_id, Request $r) {
        ...
        $table_params = [
            ...
            'place_breastfeed' => mb_strtoupper($r->place_breastfeed),
            ...
            'mnp1' => $r->mnp1,
            'mnp1_completed' => $r->mnp1_completed,
            'mnp2' => $r->mnp2,
            'mnp2_completed' => $r->mnp2_completed,
            'lns1' => $r->lns1,
            'lns1_completed' => $r->lns1_completed,
            'lns2' => $r->lns2,
            'lns2_completed' => $r->lns2_completed,
