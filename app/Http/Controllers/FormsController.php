...
class FormsController extends Controller
{
    ...
    public function store(FormValidationRequest $request)
    {
        ...
        $request->user()->form()->create([
            ...
            'testResult2' => $request->testResult2,
            ...
            'intWithOngoingCovid' => $request->intWithOngoingCovid,
