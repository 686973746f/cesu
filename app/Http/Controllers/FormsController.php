    ...
    public function store(FormValidationRequest $request)
    {
        ...
        if(Forms::where([
            ...
            ['testDateCollected1', $request->testDateCollected1]
                ...
                return redirect()->action([FormsController::class, 'index'])->with('status', 'Double Entry Error: CIF Record for '.$rec->lname.", ".$rec->fname." ".$rec->mname." already exists at ".date('m/d/Y'))->with('statustype', 'danger');
            }
            else {
