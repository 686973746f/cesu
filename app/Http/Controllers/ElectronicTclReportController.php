    ...
    public function generateM1(Request $r) {
        ...
        if(auth()->user()->isMasterAdminEtcl()) {
            if($r->filter_type == 'BHS') {
                ...
                $cn_base_qry = InhouseChildNutrition::where('enabled', 'Y')
                ->where('facility_id', $bhs_search->id);
        ...
        */
        ...
        if($r->submit == 'm1_2025') {
            ...
            $sheet->setCellValue('B87', (clone $qry)->where('bcg_time', 'WITHIN_24H')->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('C87', (clone $qry)->where('bcg_time', 'WITHIN_24H')->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());

            $sheet->setCellValue('B88', (clone $qry)->where('bcg_time', 'MORE_24H')->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('C88', (clone $qry)->where('bcg_time', 'MORE_24H')->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('B89', (clone $qry)->where('hepab_time', 'WITHIN_24H')->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('C89', (clone $qry)->where('hepab_time', 'WITHIN_24H')->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());

            $sheet->setCellValue('B90', (clone $qry)->where('hepab_time', 'MORE_24H')->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('C90', (clone $qry)->where('hepab_time', 'MORE_24H')->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('B91', (clone $qry)->where('dpt1_months', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('C91', (clone $qry)->where('dpt1_months', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('B92', (clone $qry)->where('dpt2_months', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            ...
            $sheet->setCellValue('B96', (clone $qry)->where('dpt1_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('C96', (clone $qry)->where('dpt1_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('B97', (clone $qry)->where('dpt2_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('C97', (clone $qry)->where('dpt2_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('B98', (clone $qry)->where('dpt3_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('C98', (clone $qry)->where('dpt3_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('B99', (clone $qry)->where('opv1_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('C99', (clone $qry)->where('opv1_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('B100', (clone $qry)->where('opv2_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('C100', (clone $qry)->where('opv2_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('B101', (clone $qry)->where('opv3_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('C101', (clone $qry)->where('opv3_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('B102', (clone $qry)->where('ipv1_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('C102', (clone $qry)->where('ipv1_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('B103', (clone $qry)->where('ipv2_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('C103', (clone $qry)->where('ipv2_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('Q96', (clone $qry)->where('pcv1_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('R96', (clone $qry)->where('pcv1_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('Q97', (clone $qry)->where('pcv2_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('R97', (clone $qry)->where('pcv2_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('Q98', (clone $qry)->where('pcv3_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('R98', (clone $qry)->where('pcv3_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('Q99', (clone $qry)->where('mmr1_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('R99', (clone $qry)->where('mmr1_months_py', '<=', 11)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('Q100', (clone $qry)->where('mmr2_months', '<=', 12)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('R100', (clone $qry)->where('mmr2_months', '<=', 12)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());

            $sheet->setCellValue('Q101', (clone $qry)->whereBetween('mmr2_months', [13,29])->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('R101', (clone $qry)->whereBetween('mmr2_months', [13,29])->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
        ...
        if($r->submit == 'm1_2025') {
            ...
            $sheet->setCellValue('B112', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('C112', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            ->whereYear('lb_iron3', $r->year)
            ->whereMonth('lb_iron3', $r->month)
            ->whereNotNull('lb_iron3');

            $sheet->setCellValue('B113', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('C113', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('B114', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('C114', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());

            $qry = (clone $cn_base_qry)
            ->whereYear('vita2', $r->year)
            ->whereMonth('vita2', $r->month)
            ->whereNotNull('vita2');
            ...
            $sheet->setCellValue('B119', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })
            ->where('enrolled_sfp', '1')
            ->count());
            $sheet->setCellValue('C119', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })
            ->where('enrolled_sfp', '1')
            ->count());

            $sheet->setCellValue('B120', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })
            ->where('mam_cured', '1')
            ->count());
            $sheet->setCellValue('C120', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })
            ->where('mam_cured', '1')
            ->count());
            ...
            $sheet->setCellValue('Q119', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })
            ->where('sam_noncured', '1')
            ->count());
            $sheet->setCellValue('R119', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })
            ->where('sam_noncured', '1')
            ->count());

            $sheet->setCellValue('Q120', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })
            ->where('sam_defaulted', '1')
            ->count());
            $sheet->setCellValue('R120', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })
            ->where('sam_defaulted', '1')
            ->count());
            ...
            $sheet->setCellValue('Q112', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('R112', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('Q113', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('R113', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            $sheet->setCellValue('Q114', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'MALE');
            })->count());
            $sheet->setCellValue('R114', (clone $qry)->whereHas('patient', function ($q) {
                $q->where('gender', 'FEMALE');
            })->count());
            ...
            */
            ...
            if($r->submit == 'tcl_2025') {
                ...
                */
                ...
                $spreadsheet = ExcelFactory::load(storage_path('etcl_2026/maternalcare.xlsx'));
