...
class FormValidationRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'testDateReleased1' => ($this->testResult1 != 'PENDING') ? 'nullable|date|after_or_equal:testDateCollected1|before_or_equal:today' : 'nullable|date',
            ...
            'testDateReleased2' => ($this->testResult2 != 'PENDING') ? 'nullable|date|after_or_equal:testDateCollected2|before_or_equal:today' : 'nullable|date',
            ...
            'locDateTo1' => (!is_null($this->placevisited) && in_array('Health Facility', $this->placevisited)) ? 'required|date|after_or_equal:locDateFrom1' : 'nullable',
            ...
            'locDateTo2' => (!is_null($this->placevisited) && in_array('Closed Settings', $this->placevisited)) ? 'required|date|after_or_equal:locDateFrom2' : 'nullable',
            ...
            'locDateTo3' => (!is_null($this->placevisited) && in_array('School', $this->placevisited)) ? 'required|date|after_or_equal:locDateFrom3' : 'nullable',
            ...
            'locDateTo4' => (!is_null($this->placevisited) && in_array('Workplace', $this->placevisited)) ? 'required|date|after_or_equal:locDateFrom4' : 'nullable',
            ...
            'locDateTo5' => (!is_null($this->placevisited) && in_array('Market', $this->placevisited)) ? 'required|date|after_or_equal:locDateFrom5' : 'nullable',
            ...
            'locDateTo6' => (!is_null($this->placevisited) && in_array('Social Gathering', $this->placevisited)) ? 'required|date|after_or_equal:locDateFrom6' : 'nullable',
            ...
            'locDateTo7' => (!is_null($this->placevisited) && in_array('Others', $this->placevisited)) ? 'required|date|after_or_equal:locDateFrom7' : 'nullable',
