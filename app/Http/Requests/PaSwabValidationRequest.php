...
class PaSwabValidationRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'address_street' => 'required|not_in:0,00,000,0000,N,NA,NONE,n/a,N/A,NOT APPLICABLE,NOTAPPLICABLE|min:3|regex:/(^[a-zA-Z0-9 ]+$)+/',
            'address_houseno' => 'required|not_in:0,00,000,0000,N,NA,NONE,n/a,N/A,NOT APPLICABLE,NOTAPPLICABLE|min:3|regex:/(^[a-zA-Z0-9 ]+$)+/',
            ...
            'occupation_lotbldg' => ($this->haveOccupation == 1) ? 'required|not_in:0,00,000,0000,N,NA,NONE,n/a,N/A,NOT APPLICABLE,NOTAPPLICABLE|regex:/(^[a-zA-Z0-9 ]+$)+/' : 'nullable',
            'occupation_street' => ($this->haveOccupation == 1) ? 'required|not_in:0,00,000,0000,N,NA,NONE,n/a,N/A,NOT APPLICABLE,NOTAPPLICABLE|regex:/(^[a-zA-Z0-9 ]+$)+/' : 'nullable',
