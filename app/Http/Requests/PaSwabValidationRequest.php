...
class PaSwabValidationRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'address_street' => 'required|different:address_brgy|different:address_houseno|not_in:0,00,000,0000,N,NA,NONE,n/a,N/A,NOT APPLICABLE,NOTAPPLICABLE,NEAR BRGY HALL,NEAR BARANGAY HALL|min:3|regex:/(^[a-zA-Z0-9 ]+$)+/',
            'address_houseno' => 'required|different:address_brgy|different:address_street|not_in:0,00,000,0000,N,NA,NONE,n/a,N/A,NOT APPLICABLE,NOTAPPLICABLE,NEAR BRGY HALL,NEAR BARANGAY HALL|min:3|regex:/(^[a-zA-Z0-9 ]+$)+/',
            ...
            'occupation_lotbldg' => ($this->haveOccupation == 1) ? 'required|different:occupation_brgy|different:occupation_street|not_in:0,00,000,0000,N,NA,NONE,n/a,N/A,NOT APPLICABLE,NOTAPPLICABLE,NEAR BRGY HALL,NEAR BARANGAY HALL|regex:/(^[a-zA-Z0-9 ]+$)+/' : 'nullable',
            'occupation_street' => ($this->haveOccupation == 1) ? 'required|different:occupation_brgy|different:occupation_lotbldg|not_in:0,00,000,0000,N,NA,NONE,n/a,N/A,NOT APPLICABLE,NOTAPPLICABLE,NEAR BRGY HALL,NEAR BARANGAY HALL|regex:/(^[a-zA-Z0-9 ]+$)+/' : 'nullable',
