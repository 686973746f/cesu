...
class RecordValidationRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
			...
			'address_houseno' => 'required|different:address_brgy,address_street|regex:/(^[a-zA-Z0-9 ]+$)+/',
			'address_street' => 'required|different:address_brgy,address_houseno|regex:/(^[a-zA-Z0-9 ]+$)+/',
			'address_brgy' => 'required',
			'address_city' => 'required',
			'address_province' => 'required',
			'permaaddress_houseno' => ($this->paddressdifferent == 1) ? 'required|regex:/(^[a-zA-Z0-9 ]+$)+/' : 'nullable',
			'permaaddress_street' => ($this->paddressdifferent == 1) ? 'required|regex:/(^[a-zA-Z0-9 ]+$)+/' : 'nullable',
			...
			'occupation_lotbldg' => 'nullable|different:occupation_brgy,occupation_street|regex:/(^[a-zA-Z0-9 ]+$)+/',
			'occupation_street' => 'nullable|different:occupation_brgy,occupation_lotbldg|regex:/(^[a-zA-Z0-9 ]+$)+/',
