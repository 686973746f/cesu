...
class RecordValidationRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
			...
			'address_houseno' => 'required|different:address_brgy,address_street|not_in:NEAR BRGY HALL,NEAR BARANGAY HALL|regex:/(^[a-zA-Z0-9 ]+$)+/',
			'address_street' => 'required|different:address_brgy,address_houseno|not_in:NEAR BRGY HALL,NEAR BARANGAY HALL|regex:/(^[a-zA-Z0-9 ]+$)+/',
			...
			'occupation_lotbldg' => 'nullable|different:occupation_brgy,occupation_street|not_in:NEAR BRGY HALL,NEAR BARANGAY HALL|regex:/(^[a-zA-Z0-9 ]+$)+/',
			'occupation_street' => 'nullable|different:occupation_brgy,occupation_lotbldg|not_in:NEAR BRGY HALL,NEAR BARANGAY HALL|regex:/(^[a-zA-Z0-9 ]+$)+/',
