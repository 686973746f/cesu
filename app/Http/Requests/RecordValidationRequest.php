...
class RecordValidationRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
			...
			'address_houseno' => 'required|regex:/(^[a-zA-Z0-9 ]+$)+/',
			'address_street' => 'required|regex:/(^[a-zA-Z0-9 ]+$)+/',
			...
			'occupation_lotbldg' => 'nullable|regex:/(^[a-zA-Z0-9 ]+$)+/',
			'occupation_street' => 'nullable|regex:/(^[a-zA-Z0-9 ]+$)+/',
