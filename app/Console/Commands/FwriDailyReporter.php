        ...
        if ($currentDate->greaterThanOrEqualTo($date1) && $currentDate->lessThanOrEqualTo($date2)) {
            ...
            if($list->count() != 0) {
                ...
                foreach($list as $d) {
                    ...
                    $sheet2->setCellValue('AM'.$startCell2, (in_array('BLAST/BURN INJURY WITH AMPUTATION', $exp_typeOfInjury)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('AN'.$startCell2, (in_array('BLAST/BURN INJURY NO AMPUTATION', $exp_typeOfInjury)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('AO'.$startCell2, (in_array('EYE INJURY', $exp_typeOfInjury)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('AP'.$startCell2, ($d->nature_injury == 'TETANUS') ? 'Yes' : 'No');
                    ...
                    $sheet2->setCellValue('AT'.$startCell2, (in_array('EYE', $exp_aloc)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('AU'.$startCell2, (in_array('HEAD', $exp_aloc)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('AV'.$startCell2, (in_array('CHEST', $exp_aloc)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('AW'.$startCell2, (in_array('NECK', $exp_aloc)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('AX'.$startCell2, (in_array('BACK', $exp_aloc)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('AY'.$startCell2, (in_array('ABDOMEN', $exp_aloc)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('AZ'.$startCell2, (in_array('BUTTOCKS', $exp_aloc)) ? 'Yes' : 'No');

                    $sheet2->setCellValue('BA'.$startCell2, (in_array('HAND', $exp_aloc)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('BB'.$startCell2, (in_array('FOREARM/ARM', $exp_aloc)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('BC'.$startCell2, (in_array('PELVIS', $exp_aloc)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('BD'.$startCell2, (in_array('THIGH', $exp_aloc)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('BE'.$startCell2, (in_array('LEGS', $exp_aloc)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('BF'.$startCell2, (in_array('KNEE', $exp_aloc)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('BG'.$startCell2, (in_array('FOOT', $exp_aloc)) ? 'Yes' : 'No');
                    ...
                    $sheet2->setCellValue('BN'.$startCell2, (in_array('ATS/TIG', $exp_treat)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('BO'.$startCell2, (in_array('TOXOID', $exp_treat)) ? 'Yes' : 'No');
                    $sheet2->setCellValue('BP'.$startCell2, (in_array('OTHER', $exp_treat)) ? 'Yes' : 'No');
