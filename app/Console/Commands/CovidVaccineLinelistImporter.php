...
class CovidVaccineLinelistImporter extends Command
{
    ...
    public function handle()
    {
        ...
        $filenames = [
            ...
            storage_path('app/vaxcert/masterlist/24.xlsx'),
            storage_path('app/vaxcert/masterlist/25.xlsx'),
            storage_path('app/vaxcert/masterlist/26.xlsx'),
            storage_path('app/vaxcert/masterlist/27.xlsx'),
            storage_path('app/vaxcert/masterlist/28.xlsx'),
            storage_path('app/vaxcert/masterlist/29.xlsx'),
            storage_path('app/vaxcert/masterlist/30.xlsx'),
            storage_path('app/vaxcert/masterlist/31.xlsx'),
            storage_path('app/vaxcert/masterlist/32.xlsx'),
            storage_path('app/vaxcert/masterlist/33.xlsx'),
            storage_path('app/vaxcert/masterlist/34.xlsx'),
            storage_path('app/vaxcert/masterlist/35.xlsx'),
            storage_path('app/vaxcert/masterlist/36.xlsx'),
            storage_path('app/vaxcert/masterlist/37.xlsx'),
            storage_path('app/vaxcert/masterlist/38.xlsx'),
            storage_path('app/vaxcert/masterlist/39.xlsx'),
            storage_path('app/vaxcert/masterlist/40.xlsx'),
            storage_path('app/vaxcert/masterlist/41.xlsx'),
        ];
