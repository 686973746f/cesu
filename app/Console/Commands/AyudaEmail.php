...
class AyudaEmail extends Command
{
    ...
    public function handle()
    {
        ...
        if($count != 0) {
            ...
            Mail::to(['hihihisto@gmail.com', 'cesu.gentrias@gmail.com', 'glorybemendez06@gmail.com', 'cesugentri2022@yahoo.com'])->send(new SendAyudaList($count));
        }
        else {
            Mail::to(['hihihisto@gmail.com', 'cesu.gentrias@gmail.com', 'glorybemendez06@gmail.com', 'cesugentri2022@yahoo.com'])->send(new SendAyudaListEmpty());
        }
